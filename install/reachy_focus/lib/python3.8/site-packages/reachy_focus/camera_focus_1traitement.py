"""ROS node asserving one camera and applying results to both."""
...
from reachy_msgs.srv import GetCameraFocusZoom, SetCameraFocusZoom, GetCameraZoomLevel, Set2CamerasFocus
